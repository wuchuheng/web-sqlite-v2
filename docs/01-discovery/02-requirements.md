...
**Previous**: [01 Brief](./01-brief.md) - Problem statement, users, and solution overview

**Next in Series**: [03 Scope & Glossary](./03-scope.md) - Scope boundaries and terminology
