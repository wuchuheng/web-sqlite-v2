...
async function sqlite3InitModule(moduleArg = {}) {
    ...
    function assignWasmExports(wasmExports) {
        ...
        _sqlite3_column_database_name = Module[
            "_sqlite3_column_database_name"
                ...
                try {
                    ...
                    if (fill) {
                        heap().fill(
                            0,
                            Number(m),
                            Number(m) + ctor.structInfo.sizeof
                        );
                    }
            ...
            const StructBinder = function StructBinder(structName, structInfo) {
                ...
                const StructCtor = function StructCtor(externalMemory) {
                    ...
                    if (!(this instanceof StructCtor)) {
                        ...
                        if (
                            Number.isNaN(externalMemory) ||
                            externalMemory <= zeroAsPtr
                        ) {
                            toss(
            ...
            const bindOne = function f(stmt, ndx, bindType, val) {
                ...
                switch (
                    ...
                    default:
                        ...
                        toss3(
                            "Unsupported bind() argument type: " + typeof val
                        );
                }
