import type { FileSyscalls, PathUtilities, SyscallFS, SyscallHelpers } from "../shared/system-types.d.ts";
...
export declare function createFileSyscalls(
    ...
    stringToUTF8: (value: string, outPtr: number, maxBytesToWrite: number) => number,
