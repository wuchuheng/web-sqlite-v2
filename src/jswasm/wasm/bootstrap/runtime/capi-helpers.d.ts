...
export interface Sqlite3CapiNamespace {
  ...
  sqlite3_js_vfs_create_file(...args: (string | number | Uint8Array)[]): number;
  sqlite3_js_db_export(...args: (string | number | Uint8Array)[]): Uint8Array;
...
export interface WasmExports {
  ...
  sqlite3__wasm_init_wasmfs(directoryPointer: WasmPointer): number;
...
export interface WasmBridge {
  ...
  ptrSizeof: number;
  isPtr(
    candidate: number | bigint | string | ArrayBuffer | ArrayBufferView | null,
  ): candidate is WasmPointer;
  heap8u(): Uint8Array;
...
export interface BootstrapUtilForCapi {
  isTypedArray(
    value: ArrayBuffer | ArrayBufferView | number | string | boolean | null,
  ): value is Uint8Array;
  typedArrayPart(view: Uint8Array, start: number, end: number): Uint8Array;
