...
/**
 * Creates the initializer responsible for wiring VFS helpers onto the sqlite3
 * facade. The returned function is called during bootstrap to register the
 * convenience helpers for installing custom VFS implementations.
 *
 * @returns {Sqlite3Initializer}
 *          Initializer that prepares the VFS utilities on the sqlite3 object.
 */
export function createVfsInitializer() {
    /**
     ...
     */
    return function initializeVfsUtilities(sqlite3) {
...
/**
 * Constructs the initializer that augments the sqlite3 facade with virtual
 * table helpers. The initializer mirrors the previous in-file implementation
 * but encapsulates the logic so the main bootstrap script remains focused on
 * orchestration.
 *
 * @returns {Sqlite3Initializer}
 *          Initializer that exposes virtual table utilities.
 */
export function createVtabInitializer() {
    /**
     ...
     *        The sqlite3 API object being configured by the bootstrap process.
     */
    return function initializeVtabUtilities(sqlite3) {
