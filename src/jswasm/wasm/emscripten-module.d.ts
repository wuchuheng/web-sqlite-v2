...
export interface Sqlite3Facade {
     ...
     */
    capi: Record<string, number | ((...args: (string | number | Uint8Array)[]) => number | string | void)>;
     ...
     */
    wasm: Record<string, number | boolean | ((...args: (number | string | Uint8Array)[]) => number | string | void | Uint8Array)>;
     ...
     */
    util?: Record<string, ((...args: (string | number | bigint | Uint8Array | ArrayBuffer | null)[]) => boolean | string | number | void | never)>;
     ...
     */
    config: Record<string, string | number | boolean | ((...args: (string | number)[]) => void)>;
     ...
     */
    SQLite3Error: ErrorConstructor & { toss: (...args: (string | number)[]) => never };
    WasmAllocError: ErrorConstructor & { toss: (...args: (string | number)[]) => never };
