...
var sqlite3InitModule = (() => {
    ...
    return function (moduleArg = {}) {
        ...
        Module.runSQLite3PostLoadInit = function (_EmscriptenModule) {
            "use strict";
            ...
            globalThis.sqlite3ApiBootstrap = function sqlite3ApiBootstrap(
                ...
                Object.assign(
                    config,
                    {
                        allocExportName: config.useStdAlloc
                            ? "malloc"
                            : "sqlite3_malloc",
                        deallocExportName: config.useStdAlloc
                            ? "free"
                            : "sqlite3_free",
                ...
                if (
                    config.wasmfsOpfsDir &&
                    !/^\/[^/]+$/.test(config.wasmfsOpfsDir)
                ) {
                    toss3(
                ...
                Object.assign(wasm, {
                    ...
                    exports:
                        config.exports ||
                        toss3(
                            "Missing API config.exports (WASM module exports)."
                        ),
                ...
                capi.sqlite3_js_db_uses_vfs = function (
                    pDb,
                    vfsName,
                    dbName = 0
                ) {
            ...
            globalThis.WhWasmUtilInstaller = function (target) {
                ...
                target.cstrlen = function (ptr) {
                    ...
                    let pos = ptr;
                    for (; h[pos] !== 0; ++pos) {
                        // Intentionally empty: loop increments pos until null terminator
                    }
                    return pos - ptr;
                };
                ...
                xArg.FuncPtrAdapter = class FuncPtrAdapter extends (
                    ...
                    convertArg(v, argv, _argIndex) {
                        let pair = this.singleton;
                        if (!pair && this.isContext) {
                            pair = this.contextMap(
                                this.contextKey(argv, _argIndex)
                            );
                        }
            ...
            globalThis.Jaccwabyt = function StructBinderFactory(config) {
                ...
                const __memoryDump = function () {
                    ...
                    return p
                        ? new Uint8Array(
                              heap().slice(p, p + this.structInfo.sizeof)
                          )
                        : null;
                };
                ...
                const makeMemberWrapper = function f(ctor, name, descr) {
                    if (!f._) {
                        ...
                        f.sigCheck = function (obj, name, key, sig) {
                            ...
                            if (!rxSig1.test(sig) && !rxSig2.test(sig)) {
                                toss(
                    ...
                    if (descr.readOnly) {
                        prop.set = __propThrowOnSet(
                            ctor.prototype.structName,
                            key
                        );
                    } else {
                        prop.set = function (v) {
                ...
                const StructBinder = function StructBinder(
                    structName,
                    structInfo
                ) {
                    ...
                    Object.keys(structInfo.members).forEach((k) => {
                        ...
                        if (!m.sizeof)
                            ...
                            if (m.signature !== "c" && m.signature !== "C") {
                                toss(
                    ...
                    Object.defineProperties(StructCtor, {
                        ...
                        memberKey: __memberKeyProp,
                        memberKeys: __structMemberKeys,
                        methodInfoForKey: rop(function (_mKey) {}),
                        structInfo: rop(structInfo),
                        structName: rop(structName),
                    });
                    StructCtor.prototype = new StructType(
                        structName,
                        structInfo,
                        rop
                    );
                ...
                if (!StructBinder.debugFlags) {
                    StructBinder.debugFlags = SBF.__makeDebugFlags(
                        SBF.debugFlags
                    );
                }
                return StructBinder;
            ...
            globalThis.sqlite3ApiBootstrap.initializers.push(function (
                sqlite3
            ) {
                "use strict";
                const toss = (...args) => {
...

                {
                    ...
                    if (wasm.exports.sqlite3_declare_vtab) {
                        wasm.xWrap.argAdapter("sqlite3_index_info*", (v) =>
                            __xArgPtr(
                                v instanceof
                                    (capi.sqlite3_index_info || nilType)
                                    ? v.pointer
                                    : v
                            )
                        )("sqlite3_module*", (v) =>
                    ...
                    if (wasm.exports.sqlite3__wasm_db_error) {
                        ...
                        util.sqlite3__wasm_db_error = function (
                            ...
                            if (resultCode instanceof sqlite3.WasmAllocError) {
                                ...
                                resultCode =
                                    resultCode.resultCode || capi.SQLITE_ERROR;
                            }
                            return pDb
                ...
                const __argPDb = (pDb) =>
                    wasm.xWrap.argAdapter("sqlite3*")(pDb);
                const __argStr = (str) =>
                    ...
                    capi.sqlite3_config = function (op, ...args) {
                        ...
                        switch (op) {
                            ...
                            case capi.SQLITE_CONFIG_URI:
                                return wasm.exports.sqlite3__wasm_config_i(
                                    op,
                                    args[0]
                                );
                            ...
                            case capi.SQLITE_CONFIG_MEMDB_MAXSIZE:
                                return wasm.exports.sqlite3__wasm_config_j(
                                    op,
                                    args[0]
                                );
                        ...
                        const kvvfsImpls = {
                            xRead: (zClass, zKey, zBuf, nBuf) => {
                                ...
                                try {
                                    ...
                                    const jV =
                                        kvvfsStorage(zClass).getItem(jKey);
                                    if (!jV) return -1;
                                    const nV = jV.length;
                                    if (nBuf <= 0) return nV;
                                    else if (1 === nBuf) {
                ...
                StructBinder.StructType.prototype.installMethod =
                    function callee(
                        name,
                        _func,
            ...
            globalThis.sqlite3ApiBootstrap.initializers.push(function (
                ...
                dbCtorHelper.setVfsPostOpenCallback = function (
                    pVfs,
                    callback
                ) {
                ...
                const parseExecArgs = function (db, args) {
                    ...
                    if ("string" !== typeof out.sql) {
                        toss3(
                            "Missing SQL argument or unsupported SQL value type."
                        );
                    }
                    const opt = out.opt;
                    ...
                    if (opt.callback || opt.resultRows) {
                        switch (
                            undefined === opt.rowMode ? "array" : opt.rowMode
                        ) {
                            case "object":
                    ...
                    createFunction: function f(name, xFunc, opt) {
                        ...
                        if (isFunc(xFunc)) {
                            ...
                            if (isFunc(xStep) || isFunc(xFinal)) {
                                toss3(
                                    "Ambiguous arguments: scalar or aggregate?"
                                );
                            }
                            xStep = xFinal = null;
                        ...
                        if (false === isWindow) {
                            ...
                            if (!isFunc(xInverse)) {
                                toss3(
                                    "xInverse must be provided if xValue is."
                                );
                            }
                            isWindow = true;
                ...
                const isSupportedBindType = function (v) {
                    let t =
                        BindTypes[
                            null === v || undefined === v ? "null" : typeof v
                        ];
                    switch (t) {
                ...
                const affirmParamIndex = function (stmt, key) {
                    const n =
                        "number" === typeof key
                            ? key
                            : capi.sqlite3_bind_parameter_index(
                                  stmt.pointer,
                                  key
                              );
                ...
                Stmt.prototype = {
                    ...
                    reset: function (alsoClearBinds) {
                        ...
                        const rc = capi.sqlite3_reset(
                            affirmStmtOpen(this).pointer
                        );
                        this._mayGet = false;
                    ...
                    get: function (ndx, asType) {
                        ...
                        switch (
                            ...
                            case capi.SQLITE_FLOAT:
                                return capi.sqlite3_column_double(
                                    this.pointer,
                                    ndx
                                );
                            case capi.SQLITE_TEXT:
                                return capi.sqlite3_column_text(
                                    this.pointer,
                                    ndx
                                );
                            case capi.SQLITE_BLOB: {
                    ...
                    getParamName: function (ndx) {
                        return affirmStmtOpen(this).parameterCount
                            ? capi.sqlite3_bind_parameter_name(
                                  this.pointer,
                                  ndx
                              )
                            : undefined;
                    ...
                    isBusy: function () {
                        return (
                            0 !== capi.sqlite3_stmt_busy(affirmStmtOpen(this))
                        );
                    },
                    ...
                    isReadOnly: function () {
                        return (
                            0 !==
                            capi.sqlite3_stmt_readonly(affirmStmtOpen(this))
                        );
                    },
                };
            ...
            globalThis.sqlite3ApiBootstrap.initializers.push(function (
                ...
                const installOpfsVfs = function callee(options) {
                    ...
                    const urlParams = new URL(globalThis.location.href)
                        .searchParams;
                    ...
                    if (undefined === options.sanityChecks) {
                        options.sanityChecks =
                            urlParams.has("opfs-sanity-check");
                    }
                    ...
                    const thePromise = new Promise(function (
                        ...
                        opfsUtil.getDirForFilename = async function f(
                            ...
                            const path = opfsUtil.getResolvedPath(
                                absFilename,
                                true
                            );
                        ...
                        const importDbChunked = async function (
                            ...
                            try {
                                sah.truncate(0);
                                while (
                                    undefined !== (chunk = await callback())
                                ) {
                        ...
                        opfsUtil.importDb = async function (filename, bytes) {
                            ...
                            let sah,
                                nWrote = 0;
                            try {
                                const hFile = await hDir.getFileHandle(
                                    fnamePart,
                                    { create: true }
                                );
                        ...
                        const sanityCheck = function () {
                            ...
                            try {
                                ...
                                rc = ioSyncWrappers.xTruncate(
                                    sq3File.pointer,
                                    1024
                                );
                                if (rc) toss("truncate failed w/ rc", rc);
                                wasm.poke(pOut, 0, "i64");
                                rc = ioSyncWrappers.xFileSize(
                                    sq3File.pointer,
                                    pOut
                                );
            ...
            globalThis.sqlite3ApiBootstrap.initializers.push(function (
                ...
                const HEADER_CORPUS_SIZE =
                    HEADER_MAX_PATH_SIZE + HEADER_FLAGS_SIZE;
                ...
                const ioMethods = {
                    ...
                    xClose: function (pFile) {
                        ...
                        if (file) {
                            try {
                                ...
                                file.sah.flush();
                                if (
                                    file.flags & capi.SQLITE_OPEN_DELETEONCLOSE
                                ) {
                    ...
                    xTruncate: function (pFile, sz64) {
                        ...
                        try {
                            file.sah.truncate(
                                HEADER_OFFSET_DATA + Number(sz64)
                            );
                            return 0;
                        } catch (e) {
                            return pool.storeErr(e, capi.SQLITE_IOERR);
                ...
                class OpfsSAHPool {
                    ...
                    getAssociatedPath(sah) {
                        ...
                        const flags =
                            this.#dvBody.getUint32(HEADER_OFFSET_FLAGS);
                        if (
                            this.#apBody[0] &&
                        ...
                        const fileDigest = new Uint32Array(
                            HEADER_DIGEST_SIZE / 4
                        );
                        sah.read(fileDigest, { at: HEADER_OFFSET_DIGEST });
                        const compDigest = this.computeDigest(
                            this.#apBody,
                            flags
                        );

                        if (fileDigest.every((v, i) => v === compDigest[i])) {
                            const pathBytes = this.#apBody.findIndex(
                                (v) => 0 === v
                            );
                            if (0 === pathBytes) {
                    ...
                    async reset(clearFiles) {
                        ...
                        this.#dhOpaque =
                            await this.#dhVfsRoot.getDirectoryHandle(
                                OPAQUE_DIR_NAME,
                                { create: true }
                            );
                        this.releaseAccessHandles();
                    ...
                    importDb(name, bytes) {
                        ...
                        if (n < 512 || n % 512 != 0) {
                            toss(
                                "Byte array size is invalid for an SQLite db."
                            );
                        }
                        const header = "SQLite format 3";
                        for (let i = 0; i < header.length; ++i) {
                    ...
                    return (initPromises[vfsName] = apiVersionCheck()
                        .then(async function () {
                            ...
                            return thePool.isReady
                                .then(async () => {
                                    const poolUtil = new OpfsSAHPoolUtil(
                                        thePool
                                    );
                                    if (sqlite3.oo1) {
