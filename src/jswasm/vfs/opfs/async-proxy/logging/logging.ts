...
export class WorkerLogger {
   ...
   */
  private readonly backends: Map<WorkerLogLevel, (...args: unknown[]) => void>;
  ...
  constructor(levelProvider: () => number) {
    ...
    this.backends = new Map<WorkerLogLevel, (...args: unknown[]) => void>([
...
// Assign WorkerLogger to globalThis to maintain compatibility with the original .mjs module
// eslint-disable-next-line @typescript-eslint/no-explicit-any
(globalThis as any).WorkerLogger = WorkerLogger;
