 ...
 * }} options
 * @returns {{
 *   create(path: string, mode?: number): import("./base-state.d.ts").FSNode,
 *   mkdir(path: string, mode?: number): import("./base-state.d.ts").FSNode,
 *   mkdirTree(path: string, mode?: number): void,
 *   mkdev(path: string, mode: number, dev?: number): import("./base-state.d.ts").FSNode,
 *   symlink(oldpath: string, newpath: string): import("./base-state.d.ts").FSNode,
 *   rename(oldPath: string, newPath: string): void,
 *   rmdir(path: string): void,
 *   readdir(path: string): string[],
 *   unlink(path: string): void,
 *   readlink(path: string): string,
 *   stat(path: string, dontFollow?: boolean): import("./base-state.d.ts").FSStats,
 *   lstat(path: string): import("./base-state.d.ts").FSStats,
 *   chmod(
 *     path: string | import("./base-state.d.ts").FSNode,
 *     mode: number,
 *     dontFollow?: boolean
 *   ): void,
 *   lchmod(path: string | import("./base-state.d.ts").FSNode, mode: number): void,
 ...
 *     dontFollow?: boolean
 *   ): void,
 *   lchown(path: string | import("./base-state.d.ts").FSNode, uid: number, gid: number): void,
 *   fchown(fd: number, uid: number, gid: number): void,
 *   truncate(path: string | import("./base-state.d.ts").FSNode, len: number): void,
