...
- Binding helpers convert JavaScript values to SQLite types and call sqlite3_bind_*.
...
- Binding Helpers: Determine types, allocate memory, and call sqlite3_bind_*.
